...
\documentclass[12pt,letterpaper,twoside,english,BCOR7.5mm]{article}
...
\title{Maclane pentagon is some comonadic descent (Rough Proof) (6 Pages)}
...
\maketitle
\begin{abstract}
This Coq text responds to Gross \emph{Coq Categories Experience} and
Chlipala \emph{Compositional Computational Reflection} of ITP 2014.
``Compositional'' is synonymous for functional/functorial; ``Computational
Reflection'' is synonymous for monadic semantics; and this text attempts
some comonadic descent along functorial semantics : Dosen semiassociative
coherence covers Maclane associative coherence by some comonadic adjunction,
...
This Coq text responds to Gross \emph{Coq Categories Experience} \cite{gross}
...
\cite{dosen} by some comonadic adjunction, $\text{embedding }:\ \text{SemiAssoc}\leftrightarrows\text{Assoc}\ :\text{ flattening reflection}$.
...
behind the \emph{crush} of Chlipala CPDT \cite{chlipalacpdt} is :
\begin{quote}
{[} induction; \\
...
.. This is 3 pages/day = 1 year memo reading.\include{itp2015.v}
